...
exports.familyTable = (0, sqlite_core_1.sqliteTable)("family_table", {
    ...
    parent1_mobile_phone: (0, sqlite_core_1.int)("parent1_mobile_phone").notNull(),
    ...
    alternate_contact_mobile_phone: (0, sqlite_core_1.int)("alternate_contact_mobile_phone"),
});
...
exports.studentTable = (0, sqlite_core_1.sqliteTable)("student_table", {
    ...
    family_id: (0, sqlite_core_1.int)("family_id").references(() => exports.familyTable.id),
    teacher_id: (0, sqlite_core_1.int)("teacher_id").references(() => exports.teacherTable.id),
});
